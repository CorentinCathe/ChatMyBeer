import useAPI from "../useApiCity.js";
    ...
    let data = [
      ...
      },
      {
        ...
        fields: {
          ...
          coordinates: [51.4877, -0.24980000000000002],
        ...
        geometry: {
          type: "Point",
          coordinates: [-0.24980000000000002, 51.4877]
        },
        record_timestamp: "2016-09-26T03:46:21.236000+00:00"
      },
      {
  ...
  methods: {
    brewerySelected: function(id) {
      ...
      useAPI
        .getBreweryByID(id)
        .then(data => {
          this.brewerySelectedName =
            data.nhits == 0 ? null : data.records[0].fields.name_breweries;
        })
